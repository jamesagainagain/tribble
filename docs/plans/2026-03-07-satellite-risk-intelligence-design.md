...
```json
{
  ...
  "narrative_summary": "Overall situation assessment generated by Gemini..."
}
```
...
2. For each cluster:
   ...
   - Send high-risk zones to Gemini for brief narrative
3. For cluster pairs within 25km:
   ...
   - Generate advisory text via Gemini
4. Generate overall narrative summary via Gemini
...
6. Dashboard: narratives generated by Gemini for high-risk zones
